  ...
  "zh-CN": {
    translation: {
      ...
      dashboard: {
        ...
        dismiss: "移除", dismissNotification: "移除 {{title}} 的通知", turnCompleted: "本轮已完成", approvalRequested: "等待批准",
      ...
      session: {
        ...
        removing: "正在后台停止并删除 Session…", remove: "Remove", removeBody: "永久删除此 Session 的历史和关联数据？运行中的进程将先停止。此操作不可撤销，但不会删除项目源码。", archiveBody: "停止此 Session 并归档？历史将保留，可从归档中恢复。", removeArchived: "会话已归档，但永久删除失败，可重试删除。", restartAvailable: "此 Session 已停止。你可以选择 Restart 重新启动。", retryAttach: "重试连接终端",
  ...
  "en-US": {
    translation: {
      ...
      dashboard: {
        ...
        dismiss: "Remove", dismissNotification: "Remove notification for {{title}}", turnCompleted: "Turn completed", approvalRequested: "Approval requested",
