  ...
  "zh-CN": {
    translation: {
      ...
      dashboard: {
        ...
        notificationSessionUnavailable: "此 Session 已不可打开，仍可移除此条通知。",
  ...
  "en-US": {
    translation: {
      ...
      dashboard: {
        ...
        notificationSessionUnavailable: "This Session is no longer available. You can still remove its notification.",
